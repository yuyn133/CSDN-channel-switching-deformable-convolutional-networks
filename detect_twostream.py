...
def detect(opt):
    ...
    for (path, img, im0s, vid_cap), (path_, img2, im0s_, vid_cap_) in zip(dataset, dataset2):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # #
            # # ---------------------------------------------------------------------------
            # annoPath = "/home/fqy/proj/
            # paper/test_result/gt/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='run_CFVM/train/yolov5s_llvip/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default=r'/home/yyn/Desktop/LLVIP/visible/images/test', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default=r'/home/yyn/Desktop/LLVIP/infrared/images/test', help='source')  # file/folder, 0 for webcam
