...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            # Note! Note! Note!
            # if delete 'with amp.autocast('cuda'):' may occur error 'expect half but got float'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='run_CFVM/train/yolov5l_llvip_cs/weights/best.pt', help='model.pt path(s)')
