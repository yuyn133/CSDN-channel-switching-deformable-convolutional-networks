...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        # attention : delete this may cause error
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_myfusion.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default='run_CFVM/train', help='save to project/name')
